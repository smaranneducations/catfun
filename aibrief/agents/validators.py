...
PRE_VISUAL_RULES = [
    ...
    {"id": 10, "rule": "Copy is polished, clear, and professional — well-crafted analytical content", "category": "content", "weight": 3},
...
POST_VISUAL_RULES = [
    ...
    {"id": 2,  "rule": "Layout is balanced — not too empty, not too crowded. Professional and visually appealing.", "category": "layout", "weight": 3},
    ...
    {"id": 9,  "rule": "Design quality is high — clean, modern, visually striking", "category": "design", "weight": 3},
    ...
    {"id": 15, "rule": "Color psychology applied — colors match the content emotion and tone", "category": "design_psychology", "weight": 2},
