    ...
    def __init__(self):
        super().__init__(
            ...
            system_prompt=(
                ...
                "REVIEW CRITERIA:\n"
                "1. Does each page have ONE clear, powerful idea?\n"
                "2. Does it read like luxury advertising — not a textbook?\n"
                "3. Is there enough content to fill a page beautifully?\n"
                "4. Are there concrete numbers, names, and dates?\n"
                "5. Would a CEO frame this on their wall?\n"
                "6. Is every page's body text 80-150 words (enough to fill space)?\n"
                "7. Does every page have a compelling pull quote?\n\n"
                "CRITICAL: Each page body MUST be 80-150 words minimum. "
                "Pages with < 80 words of body text will look empty.\n\n"
                "Return JSON:\n"
                "{\n"
